//
//  ClickRevealFirstVC.swift
//  RealTimeMedia
//
//  Created by Bunty on 29/03/17.
//  Copyright © 2017 Bunty. All rights reserved.
//

import UIKit

class ClickRevealFirstVC: UIViewController  , UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout{
